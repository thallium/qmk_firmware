...
//     LE = SAFE_RANGE, // macro that sends <=
//     GE,              // macro that sends >=
// };
// 
...
[_BASE] = LAYOUT(
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMMA, KC_DOT,  KC_SLSH, MT(MOD_RSFT,KC_QUOT),
  TD(TD_CTRL_PAUSE), TT(_FN), KC_LGUI, KC_LALT,  KC_LCTL,    KC_SPC,    MO(1), LGUI_T(KC_LEFT), KC_DOWN, KC_UP, KC_RGHT
),
...
[_SYM] = LAYOUT( /* Right */
  ...
  TG(_MOVE), _______, _______, _______, _______,  _______,  _______, KC_COMM, KC_DOT,  KC_SLSH, RESET
),
